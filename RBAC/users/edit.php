                ...
                <div class="wrap-login100 p-l-20 p-r-20 p-t-20 p-b-30" style="width:800px;">
                    <form class="login100-form validate-form" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="wrap-input100 validate-input m-b-16" data-validate="Role is required">
                                    <select class="input100" name='role' id='role' value="<?php echo $role; ?>" <?php if(!isset($_SESSION["admin_id"])){ echo 'disabled';}?>>
                                        <?php
                                        if ($role == "user") {
                                            ?>
                        ...
                        <div>
                            ...
                            <span><a <?php if(isset($_SESSION["admin_id"])){ echo "href='../admin'";}else{ echo "href='privilege.php'";}?>>Back to Search</a></span>
                        </div>
                    </form>
                </div>
            </div>
